...
class WebSocketConfig(val chatService: ChatService,
                      val taskScheduler: TaskScheduler,
                      @Value("\${wycode.chat.admin-passcode}")
                      val adminPasscode: String) : WebSocketMessageBrokerConfigurer {
